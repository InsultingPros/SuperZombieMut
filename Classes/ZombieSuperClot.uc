...
function ClawDamageTarget()
{
  ...
  if (MeleeDamageTarget( UsedMeleeDamage, PushDir))
  {
    ...
    if (!bDecapitated && KFP != none)
    {
      ...
      if (KFP.GetVeteran().static.CanBeGrabbed(KFPlayerReplicationInfo(KFP.PlayerReplicationInfo), self) || (disabledPawnRepInfo != none && disabledPawnRepInfo.numClotsAttached > grappleLimit))
      {
